        ...
        if(isset($_POST["btn1"])){
            ...
            if($btn=="Agregar"){
                ...
                if ($mostrar = $bd->mostrar_registros()) {
                    ...
                    mail("pame29jara@gmail.com",$asunto,$comentario,$headers);
...
//Enviamos el mensaje a tu_dirección_email
                    ...
                    if($bool){
                        echo"<script > alert('hemos enviado a su correo electronico  su contraseña  ')</script>";
        ...
        ?>
          ...
          <div class="header"> <img src="img/logo.jpg" style="display:inline" height="65px"> Aduana Chile</div>
